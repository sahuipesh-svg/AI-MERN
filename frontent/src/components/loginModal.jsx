    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            <div className="relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden p-8">
              ...
              <div className="relative px-8 pt-14 pb-10 text-center">
                <h1 className='inline-block mb-6 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs text-zinc-300'>AI-Powered website</h1>
                 ...
                 >
                  <div className='relative flex items-center justify-center gap-3'>
                    <img src="https://imgs.search.brave.com/ppiP2QtQTd348_s7bpm7s87h4U9F5iOqgAoWSao5Fdk/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9jZG4u/aWNvbnNjb3V0LmNv/bS9pY29uL2ZyZWUv/cG5nLTI1Ni9mcmVl/LWdvb2dsZS1pY29u/LXN2Zy1kb3dubG9h/ZC1wbmctMTUwNzgw/Ny5wbmc_Zj13ZWJw/Jnc9MTI4"
                    className='h-5 w-5'/>
